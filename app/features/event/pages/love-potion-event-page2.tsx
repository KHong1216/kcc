...
import type { Route } from "./+types/love-potion-event-page2";
...
export function LovePotionEventPage2({ actionData }: Route.ComponentProps) {
  ...
  return (
    <>
      ...
      />
      <div className="bg-[#FFF7F5] text-[#3B2F2F] relative overflow-hidden">
        {/* Page 1: 젤리 선택하기 */}
        {currentPage === 1 && (
          <div
            key="page-1"
            className={`${PAGE_CLASS} animate-fade-in`}
          >
        ...
        {/* Page 2: 나만의 복용 지도서 받기 */}
        {currentPage === 2 && (
          <div
            key="page-2"
            className={`${PAGE_CLASS} bg-[#FFE6EB]/60 animate-fade-in`}
          >
            <div className={CARD_CLASS}>
              <div className="space-y-3 text-center">
...
export default LovePotionEventPage2;
