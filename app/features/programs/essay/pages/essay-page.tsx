...
export const meta: MetaFunction = () => {
  ...
  return [
    { title: "아무, 말 - 리뉴얼중 | 코이창작소" },
    {
      name: "description",
      content: "아무, 말 프로그램이 2026년을 위해 리뉴얼 중입니다.",
    },
    { name: "keywords", content: "코이창작소, 아무말, 에세이, 광주 청년, 광주 창작공간" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" },
    { property: "og:type", content: "website" },
    { property: "og:url", content: url },
    { property: "og:title", content: "아무, 말 - 리뉴얼중 | 코이창작소" },
    {
    ...
    { name: "twitter:title", content: "아무, 말 - 리뉴얼중 | 코이창작소" },
    { name: "twitter:description", content: "아무, 말 프로그램이 2026년을 위해 리뉴얼 중입니다." },
